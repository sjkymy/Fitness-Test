export default function cardioGrade(gender, age, cardioValue) {
    if (gender.value === "남성" && age.value === "20") {
        ...
        : (cardioValue >= 44.9 && cardioValue < 50.2) ? console.log("양호")
    ...
    if (gender.value === "남성" && age.value === "30") {
        ...
        : (cardioValue >= 39.6 && cardioValue < 45.2) ? console.log("양호")
    ...
    if (gender.value === "남성" && age.value === "40") {
        ...
        : (cardioValue >= 35.7 && cardioValue < 40.3) ? console.log("양호")
    ...
    if (gender.value === "남성" && age.value === "50") {
        ...
        : (cardioValue >= 30.7 && cardioValue < 35.1) ? console.log("양호")
    ...
    if (gender.value === "남성" && age.value === "60") {
        ...
        : (cardioValue >= 26.6 && cardioValue < 30.5) ? console.log("양호")
    ...
    if (gender.value === "여성" && age.value === "20") {
        ...
        : (cardioValue >= 34.6 && cardioValue < 40.6) ? console.log("양호")
    ...
    if (gender.value === "여성" && age.value === "30") {
        ...
        : (cardioValue >= 28.2 && cardioValue < 32.2) ? console.log("양호")
    ...
    if (gender.value === "여성" && age.value === "40") {
        ...
        : (cardioValue >= 24.9 && cardioValue < 28.7) ? console.log("양호")
    ...
    if (gender.value === "여성" && age.value === "50") {
        ...
        : (cardioValue >= 21.8 && cardioValue < 25.2) ? console.log("양호")
    ...
    if (gender.value === "여성" && age.value === "60") {
        ...
        : (cardioValue >= 18.9 && cardioValue < 21.2) ? console.log("양호")
