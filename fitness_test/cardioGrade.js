export default function cardioGrade(gender, age, cardioValue, data) {
    if (gender.value === "남성" && age.value === "20") {
        (cardioValue >= 0 && cardioValue < 38.1) ? data.push("매우부족")
    ...
    if (gender.value === "남성" && age.value === "30") {
        (cardioValue >= 0 && cardioValue < 34.1) ? data.push("매우부족")
    ...
    if (gender.value === "남성" && age.value === "40") {
        (cardioValue >= 0 && cardioValue < 30.5) ? data.push("매우부족")
    ...
    if (gender.value === "남성" && age.value === "50") {
        (cardioValue >= 0 && cardioValue < 26.1) ? data.push("매우부족")
    ...
    if (gender.value === "남성" && age.value === "60") {
        (cardioValue >= 0 && cardioValue < 22.4) ? data.push("매우부족")
    ...
    if (gender.value === "여성" && age.value === "20") {
        (cardioValue >= 0 && cardioValue < 28.6) ? data.push("매우부족")
    ...
    if (gender.value === "여성" && age.value === "30") {
        (cardioValue >= 0 && cardioValue < 24.1) ? data.push("매우부족")
    ...
    if (gender.value === "여성" && age.value === "40") {
        (cardioValue >= 0 && cardioValue < 21.3) ? data.push("매우부족")
    ...
    if (gender.value === "여성" && age.value === "50") {
        (cardioValue >= 0 && cardioValue < 19.1) ? data.push("매우부족")
    ...
    if (gender.value === "여성" && age.value === "60") {
        (cardioValue >= 0 && cardioValue < 16.5) ? data.push("매우부족")
